...
This R Markdown serves as a tutorial for the Template Model Builder (TMB) approach to modelling preferential sampling from marine mammals. It is a companion resource to the paper "Modelling ocean temperatures from bio-probes under preferential sampling" (submitted), by Daniel Dinsdale and Matias Salibian-Barrera. 
